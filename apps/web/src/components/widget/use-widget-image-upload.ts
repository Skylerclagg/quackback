...
/**
 * Image upload for the widget's post composer and comment forms.
 *
 ...
 * no Bearer and `/api/widget/upload` 401s silently (upstream GH #464). The
 * messenger's attachment tray does the same through its own ensureSession.
 */
