...
/**
 * Upstream GH #464 regression pin: attaching/pasting an image can be a
 * first-time visitor's very first session-requiring action, and anonymous
 * widget sessions are lazily minted. The widget upload hook must establish a
 * session before POSTing to /api/widget/upload, or the request goes out with
 * no Bearer and 401s silently.
 */
...
describe('useWidgetImageUpload — session guard', () => {
  beforeEach(() => {
    clearWidgetToken()
